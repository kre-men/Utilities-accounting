...
def enter_reading(dict_er_year):
    ...
    # ввод месяца можно не предлагать вовсе, но тогда не будет возможности редактирования
    # и внесения данных за пропущенные месяца
    while True:
        dict_er = dict_er_year[year]
        ...
        # указать текущий месяц и последний заполненный месяц
                    ...
                    if ch_us in list(menu_dict["SETTINGS"].keys()):
                        ...
                        # Удаление объекта
                            ...
                            while True:
                                ...
                                if del_obj_choice in list(menu_dict["OBJECTS"].keys()):                                    # удаление объекта из меню и сохранение обновленного меню
...
# display
                            clean_console()
# top string display
# ER: ENTER/CHANGE  READINGS       DEL: DELETE READINGS       TAR: TARIFFS       B: BACK
...
# display
    ...
    print("end: ", data_base_id)
    exit_or_no = input("Save and exit (press Y),\nContinue - press any key\n").upper()
    if exit_or_no == "Y":
        break
